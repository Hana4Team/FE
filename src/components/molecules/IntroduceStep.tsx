      ...
      {step === 0 ? (
        <div className='font-hanaMedium text-2xl'>
          ...
          <div className='flex flex-col gap-5 mb-10'>
            ...
            <div>
              🔹지난달 소비내역을 참고하여 이번 달 예산을 설정하면 1단계 미션
              성공!.
            </div>
            <div>
        ...
        <div className='font-hanaMedium text-2xl'>
          ...
          <div className='flex flex-col gap-5 mb-10'>
            ...
            <div>🔹머니박스를 사용하면서 자신의 과소비지수를 확인해보아요.</div>
            <div>
              🔹한달동안 머니박스를 통해 자신의 소비를 관리하면 2단계 미션 성공!
            </div>
            <div>🔹성공하면 하나머니를 지급해드립니다.</div>
          </div>
        ...
        <div className='font-hanaMedium text-2xl'>
          ...
          <div className='flex flex-col gap-5 mb-10'>
            ...
            <div>
              🔹100일이 지난 후 3단계 성공! 50일 이상 저축에 성공할 시 최대 금리
              가 적용됩니다.
            </div>
            <div>🔹성공하면 하나머니를 지급해드립니다.</div>
          </div>
        ...
        <div className='font-hanaMedium text-2xl'>
          ...
          <div className='flex flex-col gap-5 mb-10'>
            ...
            <div>
              🔹만기일이 지난 후 4단계 성공! 목표금액 도달 시 최대 금리가
              적용됩니다.
            </div>
            <div>🔹성공하면 하나머니를 지급해드립니다.</div>
          </div>
